    ...
    <q-drawer v-model="leftDrawerOpen" side="left" overlay bordered>
      <q-list>
        ...
        <q-item
          ...
          :disable="esRutaActual('/path/home')"
        >
        ...
        <q-item
          clickable
          v-ripple
          @click="goTo('path/post')"
          :disable="esRutaActual('/path/post')"
        >
          <q-item-section avatar>
        ...
        <q-item
          clickable
          v-ripple
          @click="goTo('path/cliente')"
          :disable="esRutaActual('/path/cliente')"
        >
          <q-item-section avatar>
            <q-icon name="people" />
          </q-item-section>
        ...
        <q-item
          clickable
          v-ripple
          @click="goTo('path/producto')"
          :disable="esRutaActual('/path/producto')"
        >
          <q-item-section avatar>
            <q-icon name="tab" />
          </q-item-section>
